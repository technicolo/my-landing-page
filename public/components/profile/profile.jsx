    ...
    <>
      ...
      <section className="profile" id="profile">
        <div className="profile-description">
          <h2>Sobre mí</h2>
          <p>
            Soy un apasionado de la programación, estudiante de la Tecnicatura
            en Programación en la Universidad Austral. Disfruto crear soluciones
            prácticas y seguir perfeccionando mis habilidades en el desarrollo
            fullstack.
          </p>
        </div>
              ...
              <div className="skill-info">
                ...
                <div className="skill-stars">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <span
                      key={i}
                      className={i < skill.level ? "star filled" : "star"}
                    >
                      ★
                    </span>
                  ))}
